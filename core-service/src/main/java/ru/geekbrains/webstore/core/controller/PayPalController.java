...
import ru.geekbrains.webstore.core.service.PayPalService;
...
public class PayPalController {
  ...
  public ResponseEntity<?> captureOrder(@PathVariable String payPalId) throws IOException {
    ...
    if ("COMPLETED".equals(payPalOrder.status())) {
      ...
      orderService.setStatusPaid(orderId);
      return new ResponseEntity<>("Order paid", HttpStatus.valueOf(response.statusCode()));
    }
